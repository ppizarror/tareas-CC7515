...
#ifndef T_CC7515_HALFEDGE_H_VERTEX_H
#define T_CC7515_HALFEDGE_H_VERTEX_H
...
private:
    ...
    H_Edge *edge; // Puntero del half-edge que lo contiene
};

#endif //T_CC7515_HALFEDGE_H_VERTEX_H